...
>
	<div class="card shadow-xl px-6 py-12 flex flex-col gap-4 max-w-[25rem]">
		<form class="flex flex-col gap-2" method="post">
			...
			<button class="btn variant-filled-secondary flex gap-2" formaction="?/signIn&provider=facebook">
				<svg
					class="w-7 h-8"
					viewBox="0 0 48 48"
					version="1.1"
			...
			<button class="btn variant-filled-secondary flex gap-2" formaction="?/signIn&provider=discord">
