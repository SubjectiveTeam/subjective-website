<script lang="ts">
	...
	import { FileDropzone, ProgressRadial, toastStore } from '@skeletonlabs/skeleton';

	export let data;

	const { form, errors, constraints, enhance, submitting, tainted, capture, restore } = superForm(
		data.form,
		{
			applyAction: true,
			onResult({ result }) {
...
<h1 class="h1 !leading-loose">Update Product Group</h1>
