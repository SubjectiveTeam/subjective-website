...
<AppBar padding="py-4 px-8">
    ...
    <svelte:fragment slot="trail">
        ...
        <div class="card p-4" data-popup="cart-menu">
            ...
            <div class="flex mt-4 gap-2">
                ...
                <button disabled={$cartStore.size===0} class="btn p-2 variant-filled-error">
        ...
        <button on:click={() => cartStore.add({ id: 1, name: 'Nike Kicks', price: 5, tags: []})}>Add</button>
        <button on:click={() => cartStore.remove({ id: 1, name: 'Nike Kicks', price: 5, tags: []})}>Remove</button>
    </svelte:fragment>
</AppBar>